...
export default function Hero() {
  return (
    <section className="relative min-h-[852.27px] w-full bg-[#101828]">
      <img
        src={heroFamilyShoot}
      ...
      <div className="relative flex min-h-[852.27px] w-full flex-col items-center justify-center px-6">
        {/* category pill */}
        ...
        {/* script eyebrow */}
        <p className="pb-3 text-center font-script text-[30px] leading-[36px] font-normal whitespace-nowrap text-[rgba(255,255,255,0.65)]">
          Trusted by 12,500+ Families
        </p>

        <h1 className="max-w-[1060.858px] pb-5 text-center text-[40px] leading-[48px] font-bold text-white md:text-[56px] md:leading-[64.4px] lg:whitespace-nowrap">
          Capture Moments. Create Memories.
          <br />
          Cherish Forever.
        </h1>

        <p className="w-[576px] max-w-full pb-10 text-center text-[20px] leading-[32.5px] text-[rgba(255,255,255,0.75)]">
          Premium Photography Experiences Crafted Around Your Story
        </p>

        <div className="flex flex-wrap items-stretch justify-center gap-4 pb-14">
          <Link
            to="/book"
        ...
        <div className="flex flex-wrap items-stretch justify-center gap-3">
          {TRUST_BADGES.map(({ emoji, label }) => (
            <div
              key={label}
              className="flex shrink-0 items-center gap-2 rounded-full border-[0.701px] border-solid border-[rgba(255,255,255,0.15)] bg-[rgba(255,255,255,0.1)] px-4 py-2"
            >
